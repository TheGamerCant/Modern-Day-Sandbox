...
static const float 	BORDER_TILE					= 0.1f;
...
static const float GB_CAM_MIN = 0.1f;
...
//static const float GB_STRENGTH_CH1 = 1.0f;
//static const float GB_STRENGTH_CH2 = 0.75f;
static const float GB_STRENGTH_CH1 = 0.92f; // Opacity of bottom layer
static const float GB_STRENGTH_CH2 = 1.0f; // Opacity of top layer

static const float GB_FIRST_LAYER_PRIORITY = 0.4f; // Priority for first/second layer when both are active at the same pixel
